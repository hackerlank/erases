...
** Generated automatically by tolua++-1.0.92 on Tue Oct 22 08:36:23 2013.
*/
...
/* method: reqToServer of class  CocosNet */
#ifndef TOLUA_DISABLE_tolua_luaCocosNet_CocosNet_reqToServer00
static int tolua_luaCocosNet_CocosNet_reqToServer00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'reqToServer'",NULL);
#endif
  {
...
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'reqToServer'.",&tolua_err);
 return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE
...
static int tolua_luaCocosNet_CocosNet_sendToServer00(lua_State* tolua_S)
{
...
#endif
 {
  CocosNet* self = (CocosNet*)  tolua_tousertype(tolua_S,1,0);
  int index = ((int)  tolua_tonumber(tolua_S,2,0));
  int reqId = ((int)  tolua_tonumber(tolua_S,3,0));
  const char* content = ((const char*)  tolua_tostring(tolua_S,4,0));
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'sendToServer'",NULL);
#endif
  {
   self->sendToServer(index,reqId,content);
  }
 }
 return 0;
#ifndef TOLUA_RELEASE
...
TOLUA_API int tolua_luaCocosNet_open (lua_State* tolua_S)
{
 ...
 tolua_beginmodule(tolua_S,NULL);
  ...
  tolua_beginmodule(tolua_S,"CocosNet");
   ...
   tolua_function(tolua_S,"reqToServer",tolua_luaCocosNet_CocosNet_reqToServer00);
